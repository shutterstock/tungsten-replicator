...
public class LogicalResourceFactory extends DirectoryResourceFactory
{
    /**
     * 
     */
            ...
            ResourceNode parent) throws ResourceException
    {
        ...
        newInstance.setDirectoryType(DirectoryType.LOGICAL);
        return newInstance;
            ...
            throws ResourceException
    {
        ...
        if (parent.getResource().getType() != ResourceType.ROOT)
        {
            throw new ResourceException(String.format(
                    "You cannot create a SITE in directory of type '%s'",
