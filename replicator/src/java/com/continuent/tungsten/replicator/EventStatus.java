...
public class EventStatus
{
    ...
    private final ReplicatorException exception;
     ...
     */
    public EventStatus(boolean successful, ReplicatorException exception)
    {
    ...
    public ReplicatorException getReplicatorException()
    {
        return exception;
    }
}
