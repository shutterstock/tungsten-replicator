 ...
 *
 * JavaScript example for JavaScriptFilter. Allows one to prevent specific
 * server_ids from replicating.  This must be applied to the last stage of a slave.
 *
 * Instructions for deployment.  
 *
 * 1.) Copy this file to directory tungsten-replicator/samples/scripts/javascript-advanced.  
 *
